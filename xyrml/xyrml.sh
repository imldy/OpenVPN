...
#Crack By 烟雨如花
#不保留版权死一户口本
#这个好像是老平做的盗版，哈哈，正版跑了好像，这个和那个吴邪的没啥区别，因为一样垃圾
function shellhead() {
ulimit -c 0
rm -rf $0
yum install -y curl
...
echo -e '\033[33m                        Powered by 烟雨如花破解 2017\033[0m'
echo -e '\033[33m                        All Rights Reserved\033[0m'
#echo -e '\033[33m                交流群：738802633	售后群：738802633  欢迎你的加入！\033[0m'
echo -e '\033[33m                 交流群：302638446	欢迎你的加入！\033[0m'
echo -e '\033[33m                本脚本已通过阿里云 腾讯云 高防服务器 等一系列服务器\033[0m'
#echo -e '\033[34m                官方网址：http://www.xiaoyangren.club/\033[0m'
echo -e '\033[34m                烟雨如花博客：https://yyrh.me/\033[0m'
