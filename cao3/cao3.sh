...
==========================================================================';
	...
	sq=squid.conf;
	mp=mproxy-cg;
	Host='cdn.jsdelivr.net/gh/lingyia/OpenVPN/cao3';
	Host2='files.010521.xyz/OpenVPN/cao3';
...
sed -i "460s/admin/$adminuser/" /root/xb/web/install.sql >/dev/null 2>&1 
sed -i "460s/admin1/$adminpass/" /root/xb/web/install.sql >/dev/null 2>&1 
sed -i "s/120.77.39.82/$IP/" /root/xb/web/line.sql >/dev/null 2>&1
sed -i "s/120.77.39.82/$IP/" /root/xb/web/line.sql >/dev/null 2>&1
sed -i "s/120.77.39.82/$IP/" /root/xb/web/line.sql >/dev/null 2>&1
...
source /root/xb/web/line.sql;
source /root/xb/web/open.sql;
EOF
...
mv -f ./xb/web/* /var/www/html/ >/dev/null 2>&1
chmod 777 /var/www/html/cgmz/install >/dev/null 2>&1
rm -rf /var/www/html/cgmz/install/install.lock >/dev/null 2>&1
sleep 1
sed -i '8s/root/'$adminuser'/' /var/www/html/config.php >/dev/null 2>&1
sed -i '9s/root/'$adminpass'/' /var/www/html/config.php >/dev/null 2>&1
sed -i '7s/123456789/'$sqlpass'/' /var/www/html/cgmz/config.php >/dev/null 2>&1
cd /var/www/html/
...
sjs=`cat sjs.txt`
mv /var/www/html/config.php /var/www/html/$sjs.php >/dev/null 2>&1
sed -i '126s/config.php/'$sjs.php'/' /var/www/html/api.inc.php >/dev/null 2>&1
...
wget ${http}${Host}/dnsml.zip >/dev/null 2>&1
unzip /root/dnsml.zip >/dev/null 2>&1
mv dnsml /var/www/html
rm -rf dnsml.zip
...
sed -i "10s/ip/$IP/" /var/www/html/dnsml/views/backend/Index.htm
sed -i "10s/port/$port/" /var/www/html/dnsml/views/backend/Index.htm
sed -i "10s/admin/admin/" /var/www/html/dnsml/views/backend/Index.htm
sed -i "7s/ip/$IP/" /var/www/html/dnsml/config.php
sed -i "7s/port/$port/" /var/www/html/dnsml/config.php
sed -i "12s/password/$sqlpass/" /var/www/html/dnsml/config.php
cd /root/
#流量卫士
wget ${http}${Host}/app_api.zip >/dev/null 2>&1
...
#草根云端
mv /var/www/html/dnsml /var/www/html/app
sed -i "7s/dnsml/app/" /var/www/html/app/config.php
sed -i "193s/dnsml/app/" /var/www/html/admin/nav.php
sed -i "62s/dnsml/app/" /var/www/html/admin/notice.php
sed -i "67s/dnsml/app/" /var/www/html/admin/notice.php
sed -i "125s/dnsml/app/" /var/www/html/admin/notice.php
sed -i "130s/dnsml/app/" /var/www/html/admin/notice.php
...
echo -e "\033[34m烟雨如花™交流群：302638446 \033[0m"
...
then
clear
wget http://cdn.jsdelivr.net/gh/lingyia/OpenVPN/cao3/bbr.sh >/dev/null 2>&1
