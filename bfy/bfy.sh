...
host=;
hostfile=cdn.jsdelivr.net/gh/lingyia/OpenVPN/bfy;
...
if [[ "$installslect" == "4" ]]
then
wget https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/bfy/fix.sh;bash fix.sh
exit 0;
fi
if [[ "$installslect" == "5" ]]
then
...
wget https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/bfy/two-four.zip 
unzip two-four.zip 
rm -rf two-four.zip 
