...
downloadhost="https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/fas/";
fi
...
echo 
echo -e "\033[32m                   QQ："$qqhao"    烟雨如花博客：https://yyrh.me         \033[0m "
echo
echo -e "\033[34m----------------------------------------------------------------------------\033[0m"
echo
