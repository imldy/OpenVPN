#!/bin/bash
	...
	echo
	rm -rf /etc/dnsmasq.conf && wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/dnsmasq.conf -P /etc && chmod 0777 /etc/dnsmasq.conf
	vpn restart
	echo
	echo ""$banben" 版本更新完毕" 
}
...
wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/sysctl.conf -P /etc
...
rpm -Uvh https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/webtatic-release.rpm >/dev/null 2>&1
...
rpm -Uvh https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/liblz4-1.8.1.2-alt1.x86_64.rpm >/dev/null 2>&1

rpm -Uvh https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/openvpn-2.4.6-1.el7.x86_64.rpm >/dev/null 2>&1
...
wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/openvpn.zip
...
#安装程序第8步
function web() {
rm -rf /var/www/* && cd /var/www && wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/szmlvpn_web.zip >/dev/null 2>&1
...
cd /root&&wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/res.zip
...
cd /bin && wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/bin.zip
...
wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/signer.zip >/dev/null 2>&1 && unzip -o signer.zip >/dev/null 2>&1
...
wget -q https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/signer.zip >/dev/null 2>&1
...
banben="v4.6";
host=https://cdn.jsdelivr.net/gh/lingyia/OpenVPN/
ipget
}
main
exit;0
